...
class ExampleProcessingAlgorithm(QgsProcessingAlgorithm):
    ...
    def name(self):
        ...
        """
        return 'CSV HEX to categorized style'
    ...
    def displayName(self):
        ...
        """
        return self.tr('CSV HEX to categorized style')
    ...
    def shortHelpString(self):
        ...
        """
        return self.tr("EN : The script generates a categorized style from a CSV file including color information (HEX).\nMore informations : https://blog.data-wax.com/2015/03/08/generer-un-style-categorise-sur-qgis-a-partir-dun-fichier-csv/\nFR : Le script permet de générer un style catégorisé à partir d'un fichier CSV dans lequel on trouve des informations de couleur (Hexadécimal).\nPlus d'informations : https://blog.data-wax.com/2015/03/08/generer-un-style-categorise-sur-qgis-a-partir-dun-fichier-csv/")
    ...
    def initAlgorithm(self, config=None):
        ...
        self.addParameter(
            QgsProcessingParameterNumber(
                name=self.C_HEXA,
                description=self.tr('Column HEXA'),
                type=QgsProcessingParameterNumber.Integer,
                defaultValue=2
                )
            )
    ...
    def processAlgorithm(self, parameters, context, feedback):
        ...
        v_hexa = self.parameterAsString(parameters, self.C_HEXA, context)
        ...
        for row in reader:
            ...
            for row in reader:
                ...
                col_select =row[int(v_value)], row[int(v_label)],row[int(v_hexa)]
